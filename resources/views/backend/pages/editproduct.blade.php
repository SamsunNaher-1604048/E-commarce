    ...
    <form action="{{route('product.update',[$product->id])}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row mt-4">
            <div class="col-6">
                ...
                <input type="text" name="regular_price" class="form-control" placeholder="Title" value="{{$product->regular_price}}">
            </div>
            <div class="col-6">
                <label for="sell-price">Enter Sell price:</label><br>
                <input type="text" name="sell_price" class="form-control" placeholder="category" value="{{$product->sell_price}}">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <img src="{{asset($product->image)}}" alt="" width="180px">
            </div>
        </div>
    </form>
<div>
