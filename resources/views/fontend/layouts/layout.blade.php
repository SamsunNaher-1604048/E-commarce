...
<head>
    ...
    <body>
        <div class="body-wrapper">
            <header>
                @include('fontend.include.top-header')
                @include('fontend.include.search')
            ...
            <div class="footer">
              @include('fontend.include.footer-top')
              @include('fontend.include.footer-middle')
              @include('fontend.include.footer-bottom')
